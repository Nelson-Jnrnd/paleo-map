...
| SPEC-017 | Taxonomy infographics — clade sheet, common ancestor, descent, fan, neighbours (rooted at Dinosauria) | Draft | nelsonjeanrenaud@gmail.com | — | — | [`specs/active/SPEC-017-taxonomy-infographics.md`](specs/active/SPEC-017-taxonomy-infographics.md) |
| SPEC-018 | Map cartographic styling — bathymetric ocean, land relief, graticule, marker retune | Draft | nelsonjeanrenaud@gmail.com | — | — | [`specs/active/SPEC-018-map-cartographic-styling.md`](specs/active/SPEC-018-map-cartographic-styling.md) |
