...
| SPEC-020 | Daily Genus — a parallel well-known track, ranked by encyclopedic attention | In Implementation | nelsonjeanrenaud@gmail.com | — | — | [`specs/approved/SPEC-020-daily-genus-well-known-track.md`](specs/approved/SPEC-020-daily-genus-well-known-track.md) |
